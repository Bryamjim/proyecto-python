...
def main():
    ...
    if mayorA == mayorB and validarNumeroFibonnaci(mayorA) and validarNumeroFibonnaci(mayorB):
            print('Las 2 matrices tienen el mismo número mayor perteneciente a la serie Fibonacci')
    else:
